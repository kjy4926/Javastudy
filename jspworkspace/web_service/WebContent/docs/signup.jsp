...
<body>
	...
	<section class="loginform">
		<form method="post" name="signup-form" onsubmit="return signUp(this)" action="${pageContext.request.contextPath}/signup">
			<div class="form-group has-danger has-success">
				...
				<input type="text" placeholder="ID input" class="form-control" id="inputID" name="id"
				 	pattern="^[a-z][a-z0-9]{7,15}$" oninput="idDuplicateCheck(this.form)" required>
				...
				<button type="button" class="btn btn-primary btn-sm" onclick="dupCheck(this.form)" style="float:right;">Duplicate check</button>
