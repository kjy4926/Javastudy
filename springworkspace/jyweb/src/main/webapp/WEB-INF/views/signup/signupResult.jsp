...
<body>
	<section>
		<c:choose>
			<c:when test="${param.signupsuccess}">
				<H1>Welcome JYWeb Page!</H1>
				<div class="card">
				  <div class="card-body">
				    <h4 class="card-title">Congratulation</h4>
				    <h6 class="card-subtitle mb-2 text-muted">Sign up success!</h6>
				    <p class="card-text">Congratulations on joining JYWeb. <br>Try various functions such as bulletin boards and file uploads!</p>
			...
			<c:otherwise>
				...
				<div class="card">
				  <div class="card-body">
				    ...
				    <a href="${pageContext.request.contextPath}/index/" class="card-link">Home</a>
				    <a href="${pageContext.request.contextPath}/signup/" class="card-link">Sign up</a>
				  </div>
				</div>
			</c:otherwise>
		</c:choose>
